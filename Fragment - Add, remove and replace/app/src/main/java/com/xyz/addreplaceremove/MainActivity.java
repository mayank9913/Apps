...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mBtnReplaceAWithBBS;
    ...
    private void initViews() {
        ...
        mBtnReplaceAWithBBS = findViewById(R.id.btnReplaceAWithBBS);
        ...
        mBtnReplaceAWithBBS.setOnClickListener(this);
        mBtnAddB.setOnClickListener(this);
    ...
    private void replaceAWithBBS() {
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        FragmentB fragmentB = new FragmentB();
        fragmentTransaction.replace(R.id.flContainer, fragmentB, "FragmentB").addToBackStack("replaceAWithBBS").commit();
